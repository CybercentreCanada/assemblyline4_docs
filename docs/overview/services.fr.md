...
| OneNoteAnalyzer | OneNote Documents | Ce service extrait les pièces jointes et les métadonnées des fichiers Microsoft Onenote avec l'outil C# [OneNoteAnalyzer](https://github.com/knight0x07/OneNoteAnalyzer) | [link](https://github.com/CybercentreCanada/assemblyline-service-onenoteanalyzer)|
