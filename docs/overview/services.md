...
| OneNoteAnalyzer | OneNote Documents | This Assemblyline service extracts attachements and metadata from Microsoft Onenote files using the C# tool [OneNoteAnalyzer](https://github.com/knight0x07/OneNoteAnalyzer) | [link](https://github.com/CybercentreCanada/assemblyline-service-onenoteanalyzer)|
