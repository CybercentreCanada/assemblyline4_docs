...
| Espresso          | Java | All classes are extracted, decompiled, and analyzed for malicious behaviour | [link](https://github.com/CybercentreCanada/assemblyline-service-espresso)|
...
| MetaPeek          | Meta data analysis | Checks submission metadata for indicators of potential malicious behaviour (double file extensions, ...) | [link](https://github.com/CybercentreCanada/assemblyline-service-metapeek)|
