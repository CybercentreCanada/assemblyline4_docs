...
| :--- | :--- | :--- | :--- | :--- |
| auth | [Auth](/odm/models/config/#auth) | Authentication module configuration | :material-checkbox-marked-outline: Yes | See [Auth](/odm/models/config/#auth) for more details. |
| core | [Core](/odm/models/config/#core) | Core component configuration | :material-checkbox-marked-outline: Yes | See [Core](/odm/models/config/#core) for more details. |
| datastore | [Datastore](/odm/models/config/#datastore) | Datastore configuration | :material-checkbox-marked-outline: Yes | See [Datastore](/odm/models/config/#datastore) for more details. |
| datasources | Mapping [[Datasource](/odm/models/config/#datasource)] | Datasources configuration | :material-checkbox-marked-outline: Yes | See [Datasource](/odm/models/config/#datasource) for more details. |
| filestore | [Filestore](/odm/models/config/#filestore) | Filestore configuration | :material-checkbox-marked-outline: Yes | See [Filestore](/odm/models/config/#filestore) for more details. |
| logging | [Logging](/odm/models/config/#logging) | Logging configuration | :material-checkbox-marked-outline: Yes | See [Logging](/odm/models/config/#logging) for more details. |
| services | [Services](/odm/models/config/#services) | Service configuration | :material-checkbox-marked-outline: Yes | See [Services](/odm/models/config/#services) for more details. |
| system | [System](/odm/models/config/#system) | System configuration | :material-checkbox-marked-outline: Yes | See [System](/odm/models/config/#system) for more details. |
| ui | [UI](/odm/models/config/#ui) | UI configuration parameters | :material-checkbox-marked-outline: Yes | See [UI](/odm/models/config/#ui) for more details. |
| submission | [Submission](/odm/models/config/#submission) | Options for how submissions will be processed | :material-checkbox-marked-outline: Yes | See [Submission](/odm/models/config/#submission) for more details. |
...
| internal | [Internal](/odm/models/config/#internal) | Internal authentication settings | :material-checkbox-marked-outline: Yes | See [Internal](/odm/models/config/#internal) for more details. |
| ldap | [LDAP](/odm/models/config/#ldap) | LDAP settings | :material-checkbox-marked-outline: Yes | See [LDAP](/odm/models/config/#ldap) for more details. |
| oauth | [OAuth](/odm/models/config/#oauth) | OAuth settings | :material-checkbox-marked-outline: Yes | See [OAuth](/odm/models/config/#oauth) for more details. |
...
| password_requirements | [PasswordRequirement](/odm/models/config/#passwordrequirement) | Password requirements | :material-checkbox-marked-outline: Yes | See [PasswordRequirement](/odm/models/config/#passwordrequirement) for more details. |
| signup | [Signup](/odm/models/config/#signup) | Signup method | :material-checkbox-marked-outline: Yes | See [Signup](/odm/models/config/#signup) for more details. |
...
| smtp | [SMTP](/odm/models/config/#smtp) | Signup via SMTP | :material-checkbox-marked-outline: Yes | See [SMTP](/odm/models/config/#smtp) for more details. |
| notify | [Notify](/odm/models/config/#notify) | Signup via GC Notify | :material-checkbox-marked-outline: Yes | See [Notify](/odm/models/config/#notify) for more details. |
...
| providers | Mapping [[OAuthProvider](/odm/models/config/#oauthprovider)] | OAuth provider configuration | :material-checkbox-marked-outline: Yes | See [OAuthProvider](/odm/models/config/#oauthprovider) for more details. |
...
| auto_properties | List [[OAuthAutoProperty](/odm/models/config/#oauthautoproperty)] | Automatic role and classification assignments | :material-checkbox-marked-outline: Yes | `[]` |
| app_provider | [AppProvider](/odm/models/config/#appprovider) | None | :material-minus-box-outline: Optional | `None` |
...
| client_kwargs | Mapping [Keyword] | Keyword arguments passed to the different URLs | :material-minus-box-outline: Optional | `None` |
...
| type | Enum | Type of property assignment on pattern match<br>Values:<br>`"role", "classification", "access"` | :material-checkbox-marked-outline: Yes | `[]` |
...
| Field | Type | Description | Required | Default |
| :--- | :--- | :--- | :--- | :--- |
| alerter | [Alerter](/odm/models/config/#alerter) | Configuration for Alerter | :material-checkbox-marked-outline: Yes | See [Alerter](/odm/models/config/#alerter) for more details. |
| dispatcher | [Dispatcher](/odm/models/config/#dispatcher) | Configuration for Dispatcher | :material-checkbox-marked-outline: Yes | See [Dispatcher](/odm/models/config/#dispatcher) for more details. |
| expiry | [Expiry](/odm/models/config/#expiry) | Configuration for Expiry | :material-checkbox-marked-outline: Yes | See [Expiry](/odm/models/config/#expiry) for more details. |
| ingester | [Ingester](/odm/models/config/#ingester) | Configuration for Ingester | :material-checkbox-marked-outline: Yes | See [Ingester](/odm/models/config/#ingester) for more details. |
| metrics | [Metrics](/odm/models/config/#metrics) | Configuration for Metrics Collection | :material-checkbox-marked-outline: Yes | See [Metrics](/odm/models/config/#metrics) for more details. |
| redis | [Redis](/odm/models/config/#redis) | Configuration for Redis instances | :material-checkbox-marked-outline: Yes | See [Redis](/odm/models/config/#redis) for more details. |
| scaler | [Scaler](/odm/models/config/#scaler) | Configuration for Scaler | :material-checkbox-marked-outline: Yes | See [Scaler](/odm/models/config/#scaler) for more details. |
...
| Field | Type | Description | Required | Default |
| :--- | :--- | :--- | :--- | :--- |
| alert_ttl | Integer | None | :material-checkbox-marked-outline: Yes | `90` |
| constant_alert_fields | List [Keyword] | None | :material-checkbox-marked-outline: Yes | `['alert_id', 'file', 'ts']` |
| default_group_field | Keyword | None | :material-checkbox-marked-outline: Yes | `file.sha256` |
| delay | Integer | None | :material-checkbox-marked-outline: Yes | `300` |
| filtering_group_fields | List [Keyword] | None | :material-checkbox-marked-outline: Yes | `['file.name', 'status', 'priority']` |
| non_filtering_group_fields | List [Keyword] | None | :material-checkbox-marked-outline: Yes | `['file.md5', 'file.sha1', 'file.sha256']` |
| process_alert_message | Keyword | None | :material-checkbox-marked-outline: Yes | `assemblyline_core.alerter.processing.process_alert_message` |
...
| sampling_at | Mapping [Integer] | Thresholds at certain buckets before sampling | :material-checkbox-marked-outline: Yes | `None` |
...
| Field | Type | Description | Required | Default |
| :--- | :--- | :--- | :--- | :--- |
| apm_server | [APMServer](/odm/models/config/#apmserver) | APM server configuration | :material-checkbox-marked-outline: Yes | See [APMServer](/odm/models/config/#apmserver) for more details. |
| elasticsearch | [ESMetrics](/odm/models/config/#esmetrics) | Where to export metrics? | :material-checkbox-marked-outline: Yes | See [ESMetrics](/odm/models/config/#esmetrics) for more details. |
| export_interval | Integer | How often should we be exporting metrics? | :material-checkbox-marked-outline: Yes | `5` |
| redis | [RedisServer](/odm/models/config/#redisserver) | Redis for Dashboard metrics | :material-checkbox-marked-outline: Yes | See [RedisServer](/odm/models/config/#redisserver) for more details. |
...
| unit | Enum | Unit of time used by `warm`, `cold`, `delete` phases<br>Values:<br>`"h", "m", "d"` | :material-checkbox-marked-outline: Yes | `d` |
...
| Field | Type | Description | Required | Default |
| :--- | :--- | :--- | :--- | :--- |
| nonpersistent | [RedisServer](/odm/models/config/#redisserver) | A volatile Redis instance | :material-checkbox-marked-outline: Yes | See [RedisServer](/odm/models/config/#redisserver) for more details. |
| persistent | [RedisServer](/odm/models/config/#redisserver) | A persistent Redis instance | :material-checkbox-marked-outline: Yes | See [RedisServer](/odm/models/config/#redisserver) for more details. |
...
| :--- | :--- | :--- | :--- | :--- |
| host | Keyword | Hostname of Redis instance | :material-checkbox-marked-outline: Yes | `127.0.0.1` |
| port | Integer | Port of Redis instance | :material-checkbox-marked-outline: Yes | `6380` |
...
| Field | Type | Description | Required | Default |
| :--- | :--- | :--- | :--- | :--- |
| service_defaults | [ScalerServiceDefaults](/odm/models/config/#scalerservicedefaults) | Defaults Scaler will assign to a service. | :material-checkbox-marked-outline: Yes | `None` |
...
| environment | List [[EnvironmentVariable](/odm/models/servic/#environmentvariable)] | Environment variables to pass onto services | :material-checkbox-marked-outline: Yes | `[]` |
...
| config | Mapping [Keyword] | None | :material-checkbox-marked-outline: Yes | `None` |
...
| Field | Type | Description | Required | Default |
| :--- | :--- | :--- | :--- | :--- |
| hosts | List [Keyword] | List of hosts used for the datastore | :material-checkbox-marked-outline: Yes | `['http://elastic:devpass@localhost']` |
| ilm | [ILM](/odm/models/config/#ilm) | Index Lifecycle Management Policy | :material-checkbox-marked-outline: Yes | See [ILM](/odm/models/config/#ilm) for more details. |
...
| Field | Type | Description | Required | Default |
| :--- | :--- | :--- | :--- | :--- |
| enabled | Boolean | Are we enabling ILM across indices? | :material-checkbox-marked-outline: Yes | `False` |
| days_until_archive | Integer | Days until documents get archived | :material-checkbox-marked-outline: Yes | `15` |
| indexes | [ILMIndexes](/odm/models/config/#ilmindexes) | Index-specific ILM policies | :material-checkbox-marked-outline: Yes | See [ILMIndexes](/odm/models/config/#ilmindexes) for more details. |
| update_archive | Boolean | Do we want to update documents in the archive? | :material-checkbox-marked-outline: Yes | `False` |


[comment]: # (AUTOGENERATED MARKDOWN CONTENT. UPDATES TO ODM DOCUMENTATION SHOULD BE DONE THROUGH ASSEMBLYLINE-BASE REPO!)
#### ILMIndexes
> ILM Policies for Core Indices

| Field | Type | Description | Required | Default |
| :--- | :--- | :--- | :--- | :--- |
| alert | [ILMParams](/odm/models/config/#ilmparams) | ILM for 'alert' index | :material-checkbox-marked-outline: Yes | See [ILMParams](/odm/models/config/#ilmparams) for more details. |
| error | [ILMParams](/odm/models/config/#ilmparams) | ILM for 'error' index | :material-checkbox-marked-outline: Yes | See [ILMParams](/odm/models/config/#ilmparams) for more details. |
| file | [ILMParams](/odm/models/config/#ilmparams) | ILM for 'file' index | :material-checkbox-marked-outline: Yes | See [ILMParams](/odm/models/config/#ilmparams) for more details. |
| result | [ILMParams](/odm/models/config/#ilmparams) | ILM for 'result' index | :material-checkbox-marked-outline: Yes | See [ILMParams](/odm/models/config/#ilmparams) for more details. |
| submission | [ILMParams](/odm/models/config/#ilmparams) | ILM for 'submission' index | :material-checkbox-marked-outline: Yes | See [ILMParams](/odm/models/config/#ilmparams) for more details. |
...
| Field | Type | Description | Required | Default |
| :--- | :--- | :--- | :--- | :--- |
| warm | Integer | How long, per unit of time, should a document remain in the 'warm' tier? | :material-checkbox-marked-outline: Yes | `5` |
| cold | Integer | How long, per unit of time, should a document remain in the 'cold' tier? | :material-checkbox-marked-outline: Yes | `15` |
| delete | Integer | How long, per unit of time, should a document remain before being deleted? | :material-checkbox-marked-outline: Yes | `30` |
| unit | Enum | Unit of time used by `warm`, `cold`, `delete` phases<br>Values:<br>`"h", "m", "d"` | :material-checkbox-marked-outline: Yes | `d` |
...
| Field | Type | Description | Required | Default |
| :--- | :--- | :--- | :--- | :--- |
| log_level | Enum | What level of logging should we have?<br>Values:<br>`"DEBUG", "ERROR", "DISABLED", "INFO", "WARNING", "CRITICAL"` | :material-checkbox-marked-outline: Yes | `INFO` |
...
| image_variables | Mapping [Keyword] | Substitution variables for image paths (for custom registry support) | :material-checkbox-marked-outline: Yes | `None` |
| update_image_variables | Mapping [Keyword] | Similar to `image_variables` but only applied to the updater. Intended for use with local registries. | :material-checkbox-marked-outline: Yes | `None` |
...
| tag_types | [TagTypes](/odm/models/config/#tagtypes) | Tag types that show up in the submission summary | :material-checkbox-marked-outline: Yes | See [TagTypes](/odm/models/config/#tagtypes) for more details. |
...
| type | Enum | Type of system<br>Values:<br>`"staging", "development", "production"` | :material-checkbox-marked-outline: Yes | `production` |
...
| Field | Type | Description | Required | Default |
| :--- | :--- | :--- | :--- | :--- |
| alerting_meta | [AlertingMeta](/odm/models/config/#alertingmeta) | Alerting metadata fields | :material-checkbox-marked-outline: Yes | See [AlertingMeta](/odm/models/config/#alertingmeta) for more details. |
...
| download_encoding | Enum | Which encoding will be used for downloads?<br>Values:<br>`"raw", "cart"` | :material-checkbox-marked-outline: Yes | `cart` |
...
| statistics | [Statistics](/odm/models/config/#statistics) | Statistics configuration | :material-checkbox-marked-outline: Yes | See [Statistics](/odm/models/config/#statistics) for more details. |
...
| url_submission_headers | Mapping [Keyword] | Headers used by the url_download method | :material-minus-box-outline: Optional | `None` |
| url_submission_proxies | Mapping [Keyword] | Proxy used by the url_download method | :material-minus-box-outline: Optional | `None` |
...
| Field | Type | Description | Required | Default |
| :--- | :--- | :--- | :--- | :--- |
| important | List [Keyword] | Metadata keys that are considered important | :material-checkbox-marked-outline: Yes | `['protocol', 'subject', 'submitted_url', 'source_url', 'url', 'web_url', 'from', 'to', 'cc', 'bcc', 'ip_src', 'ip_dst', 'source']` |
