...
| aad_fic_token_file_path | Keyword | Path to the token file for authentication using Azure AD Federated Identity Credentials | <div style="width:100px">:material-minus-box-outline: Optional</div> | `None` |
