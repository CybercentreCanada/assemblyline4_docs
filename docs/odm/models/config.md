...
| resource_type | Enum | Type of mountable Kubernetes resource<br>Values:<br>`"configmap", "secret", "volume"` | :material-checkbox-marked-outline: Yes | `[]` |
| resource_name | Keyword | Name of resource (Kubernetes only) | :material-minus-box-outline: Optional | `[]` |
| resource_key | Keyword | Key of ConfigMap/Secret (Kubernetes only) | :material-minus-box-outline: Optional | `[]` |
| config_map | Keyword | Name of ConfigMap (Kubernetes only, deprecated) | :material-minus-box-outline: Optional | `[]` |
| key | Keyword | Key of ConfigMap (Kubernetes only, deprecated) | :material-minus-box-outline: Optional | `[]` |
