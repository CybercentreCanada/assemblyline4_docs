...
| datasources | Mapping [[Datasource](assemblyline4_docs/odm/models/config/#datasource)] | Datasources configuration | :material-checkbox-marked-outline: Yes | See [Datasource](assemblyline4_docs/odm/models/config/#datasource) for more details. |
...
| providers | Mapping [[OAuthProvider](assemblyline4_docs/odm/models/config/#oauthprovider)] | OAuth provider configuration | :material-checkbox-marked-outline: Yes | See [OAuthProvider](assemblyline4_docs/odm/models/config/#oauthprovider) for more details. |
...
| auto_properties | List [[OAuthAutoProperty](assemblyline4_docs/odm/models/config/#oauthautoproperty)] | Automatic role and classification assignments | :material-checkbox-marked-outline: Yes | `[]` |
...
| unit | Enum | Unit of time used by `warm`, `cold`, `delete` phases<br>Values:<br>`"m", "d", "h"` | :material-checkbox-marked-outline: Yes | `d` |
...
| environment | List [[EnvironmentVariable](assemblyline4_docs/odm/models/servic/#environmentvariable)] | Environment variables to pass onto services | :material-checkbox-marked-outline: Yes | `[]` |
...
| ilm | [ILM](assemblyline4_docs/odm/models/config/#ilm) | Index Lifecycle Management Policy | :material-checkbox-marked-outline: Yes | See [ILM](assemblyline4_docs/odm/models/config/#ilm) for more details. |
...
| indexes | [ILMIndexes](assemblyline4_docs/odm/models/config/#ilmindexes) | Index-specific ILM policies | :material-checkbox-marked-outline: Yes | See [ILMIndexes](assemblyline4_docs/odm/models/config/#ilmindexes) for more details. |
...
| Field | Type | Description | Required | Default |
| :--- | :--- | :--- | :--- | :--- |
| alert | [ILMParams](assemblyline4_docs/odm/models/config/#ilmparams) | ILM for 'alert' index | :material-checkbox-marked-outline: Yes | See [ILMParams](assemblyline4_docs/odm/models/config/#ilmparams) for more details. |
| error | [ILMParams](assemblyline4_docs/odm/models/config/#ilmparams) | ILM for 'error' index | :material-checkbox-marked-outline: Yes | See [ILMParams](assemblyline4_docs/odm/models/config/#ilmparams) for more details. |
| file | [ILMParams](assemblyline4_docs/odm/models/config/#ilmparams) | ILM for 'file' index | :material-checkbox-marked-outline: Yes | See [ILMParams](assemblyline4_docs/odm/models/config/#ilmparams) for more details. |
| result | [ILMParams](assemblyline4_docs/odm/models/config/#ilmparams) | ILM for 'result' index | :material-checkbox-marked-outline: Yes | See [ILMParams](assemblyline4_docs/odm/models/config/#ilmparams) for more details. |
| submission | [ILMParams](assemblyline4_docs/odm/models/config/#ilmparams) | ILM for 'submission' index | :material-checkbox-marked-outline: Yes | See [ILMParams](assemblyline4_docs/odm/models/config/#ilmparams) for more details. |
...
| Field | Type | Description | Required | Default |
| :--- | :--- | :--- | :--- | :--- |
| log_level | Enum | What level of logging should we have?<br>Values:<br>`"ERROR", "DEBUG", "DISABLED", "WARNING", "INFO", "CRITICAL"` | :material-checkbox-marked-outline: Yes | `INFO` |
...
| preferred_registry_type | Enum | Global registry type to be used for fetching updates for a service (overridable by a service)<br>Values:<br>`"harbor", "docker"` | :material-checkbox-marked-outline: Yes | `docker` |
...
| type | Enum | Type of system<br>Values:<br>`"development", "staging", "production"` | :material-checkbox-marked-outline: Yes | `production` |
...
| banner_level | Enum | Banner message level<br>Values:<br>`"success", "error", "warning", "info"` | :material-checkbox-marked-outline: Yes | `info` |
