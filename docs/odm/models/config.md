...
| type | Enum | Type of property assignment on pattern match<br>Values:<br>`"access", "classification", "role"` | :material-checkbox-marked-outline: Yes | `[]` |
...
| conditions | Mapping [Keyword] | None | :material-checkbox-marked-outline: Yes | `None` |
