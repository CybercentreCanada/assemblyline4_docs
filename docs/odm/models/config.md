...
| type | Enum | Type of property assignment on pattern match<br>Values:<br>`"access", "classification", "remove_role", "role", "type"` | :material-checkbox-marked-outline: Yes | `None` |
