...
| type | Enum | Type of property assignment on pattern match<br>Values:<br>`"classification", "access", "role"` | :material-checkbox-marked-outline: Yes | `[]` |
...
| Field | Type | Description | Required | Default |
| :--- | :--- | :--- | :--- | :--- |
| log_level | Enum | What level of logging should we have?<br>Values:<br>`"WARNING", "DEBUG", "DISABLED", "CRITICAL", "ERROR", "INFO"` | :material-checkbox-marked-outline: Yes | `INFO` |
...
| banner_level | Enum | Banner message level<br>Values:<br>`"warning", "success", "info", "error"` | :material-checkbox-marked-outline: Yes | `info` |
