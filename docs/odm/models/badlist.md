...
| type | Enum | Type of bad hash<br>Supported values are:<br>`"file", "tag"` | <div style="width:100px">:material-checkbox-marked-outline: Yes</div> | `None` |
...
| type | Enum | Type of badlisting source<br>Supported values are:<br>`"external", "user"` | <div style="width:100px">:material-checkbox-marked-outline: Yes</div> | `None` |
