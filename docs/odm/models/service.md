...
| submission_params | List [[SubmissionParams](/odm/models/service/#submissionparams)] | Submission parameters of service | :material-checkbox-marked-outline: Yes | `[]` |
| timeout | Integer | Service task timeout, in seconds | :material-checkbox-marked-outline: Yes | `60` |
| docker_config | [DockerConfig](/odm/models/service/#dockerconfig) | Docker configuration for service | :material-checkbox-marked-outline: Yes | `None` |
| dependencies | Mapping [[DependencyConfig](/odm/models/service/#dependencyconfig)] | Dependency configuration for service | :material-checkbox-marked-outline: Yes | See [DependencyConfig](/odm/models/service/#dependencyconfig) for more details. |
| update_channel | Enum | What channel to watch for service updates?<br>Values:<br>`"rc", "beta", "dev", "stable"` | :material-checkbox-marked-outline: Yes | `stable` |
| update_config | [UpdateConfig](/odm/models/service/#updateconfig) | Update configuration for fetching external resources | :material-minus-box-outline: Optional | `None` |
...
| Field | Type | Description | Required | Default |
| :--- | :--- | :--- | :--- | :--- |
| container | [DockerConfig](/odm/models/service/#dockerconfig) | Docker container configuration for dependency | :material-checkbox-marked-outline: Yes | `None` |
| volumes | Mapping [[PersistentVolume](/odm/models/service/#persistentvolume)] | Volume configuration for dependency | :material-checkbox-marked-outline: Yes | See [PersistentVolume](/odm/models/service/#persistentvolume) for more details. |
...
| environment | List [[EnvironmentVariable](/odm/models/service/#environmentvariable)] | Additional environemnt variables for the container | :material-checkbox-marked-outline: Yes | `[]` |
...
| type | Enum | Type of parameter<br>Values:<br>`"list", "int", "str", "bool"` | :material-checkbox-marked-outline: Yes | `[]` |
...
| sources | List [[UpdateSource](/odm/models/service/#updatesource)] | List of external sources | :material-checkbox-marked-outline: Yes | `[]` |
...
| signature_delimiter | Enum | Delimiter used when given a list of signatures<br>Values:<br>`"space", "double_new_line", "none", "custom", "comma", "new_line", "file", "pipe"` | :material-checkbox-marked-outline: Yes | `double_new_line` |
...
| headers | List [[EnvironmentVariable](/odm/models/service/#environmentvariable)] | Headers | :material-checkbox-marked-outline: Yes | `[]` |
