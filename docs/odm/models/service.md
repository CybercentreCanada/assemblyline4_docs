...
| Field | Type | Description | Required | Default |
| :--- | :--- | :--- | :--- | :--- |
| name | Keyword | Name of Environment Variable | :material-checkbox-marked-outline: Yes | `None` |
| value | Keyword | Value of Environment Variable | :material-checkbox-marked-outline: Yes | `None` |
...
| Field | Type | Description | Required | Default |
| :--- | :--- | :--- | :--- | :--- |
| default | Any | Default value (must match value in `value` field) | :material-checkbox-marked-outline: Yes | `None` |
| name | Keyword | Name of parameter | :material-checkbox-marked-outline: Yes | `None` |
| type | Enum | Type of parameter<br>Values:<br>`"bool", "int", "list", "str"` | :material-checkbox-marked-outline: Yes | `None` |
| value | Any | Default value (must match value in `default` field) | :material-checkbox-marked-outline: Yes | `None` |
| list | Any | List of values if `type: list` | :material-minus-box-outline: Optional | `None` |
| hide | Boolean | Should this parameter be hidden? | :material-checkbox-marked-outline: Yes | `False` |
...
| Field | Type | Description | Required | Default |
| :--- | :--- | :--- | :--- | :--- |
| name | Keyword | Name of source | :material-checkbox-marked-outline: Yes | `None` |
