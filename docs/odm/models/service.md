...
| update_channel | Enum | What channel to watch for service updates?<br>Values:<br>`"dev", "stable", "rc", "beta"` | :material-checkbox-marked-outline: Yes | `stable` |
...
| registry_type | Enum | The type of container registry<br>Values:<br>`"harbor", "docker"` | :material-checkbox-marked-outline: Yes | `docker` |
...
| type | Enum | Type of parameter<br>Values:<br>`"int", "bool", "str", "list"` | :material-checkbox-marked-outline: Yes | `[]` |
...
| signature_delimiter | Enum | Delimiter used when given a list of signatures<br>Values:<br>`"pipe", "new_line", "file", "custom", "comma", "space", "double_new_line", "none"` | :material-checkbox-marked-outline: Yes | `double_new_line` |
