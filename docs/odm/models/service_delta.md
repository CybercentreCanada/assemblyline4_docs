...
| update_channel | Enum | Refer to:<br>[Service](../service/#service)<br>Values:<br>`"dev", "stable", "rc", "beta"` | :material-minus-box-outline: Optional | `None` |
...
| registry_type | Enum | None<br>Values:<br>`"harbor", "docker"` | :material-minus-box-outline: Optional | `None` |
...
| type | Enum | Refer to:<br>[Service - SubmissionParams](../service/#submissionparams)<br>Values:<br>`"int", "bool", "str", "list"` | :material-minus-box-outline: Optional | `None` |
...
| signature_delimiter | Enum | Refer to:<br>[Service - UpdateConfig](../service/#updateconfig)<br>Values:<br>`"pipe", "new_line", "file", "custom", "comma", "space", "double_new_line", "none"` | :material-minus-box-outline: Optional | `None` |
