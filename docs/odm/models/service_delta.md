...
| update_channel | Enum | Refer to:<br>[Service](../service/#service)<br>Supported values are:<br>`"beta", "dev", "rc", "stable"` | <div style="width:100px">:material-minus-box-outline: Optional</div> | `None` |
...
| registry_type | Enum | Refer to:<br>[Service - DockerConfig](../service/#dockerconfig)<br>Supported values are:<br>`"docker", "harbor"` | <div style="width:100px">:material-minus-box-outline: Optional</div> | `None` |
...
| access_mode | Enum | Refer to:<br>[Service - PeristentVolume](../service/#persistentvolume)<br>Supported values are:<br>`"ReadWriteMany", "ReadWriteOnce"` | <div style="width:100px">:material-minus-box-outline: Optional</div> | `None` |
...
| type | Enum | Refer to:<br>[Service - SubmissionParams](../service/#submissionparams)<br>Supported values are:<br>`"bool", "int", "list", "str"` | <div style="width:100px">:material-minus-box-outline: Optional</div> | `None` |
...
| signature_delimiter | Enum | Refer to:<br>[Service - UpdateConfig](../service/#updateconfig)<br>Supported values are:<br>`"comma", "custom", "double_new_line", "file", "new_line", "none", "pipe", "space"` | <div style="width:100px">:material-minus-box-outline: Optional</div> | `None` |
...
| post_data | Mapping [String, Any] | Refer to:<br>[Service - UpdateSource](../service/#updatesource) | <div style="width:100px">:material-minus-box-outline: Optional</div> | `{}` |
