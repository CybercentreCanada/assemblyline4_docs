...
| priority | Enum | Priority applied by the workflow<br>Values:<br>`"HIGH", "MEDIUM", "CRITICAL", "LOW", None` | :material-minus-box-outline: Optional | `None` |
| query | Keyword | Query that the workflow runs | :material-checkbox-marked-outline: Yes | `None` |
| status | Enum | Status applied by the workflow<br>Values:<br>`"MALICIOUS", "ASSESS", "NON-MALICIOUS", "TRIAGE", None` | :material-minus-box-outline: Optional | `None` |
