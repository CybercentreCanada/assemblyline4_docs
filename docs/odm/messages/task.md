...
| ignore_filtering | Boolean | Should the service filter it's output? | :material-checkbox-marked-outline: Yes | `False` |
| priority | Integer | Priority for processing order | :material-checkbox-marked-outline: Yes | `0` |
| safelist_config | [ServiceSafelist](/assemblyline4_docs/odm/models/config/#servicesafelist) | Safelisting configuration (as defined in global configuration) | :material-checkbox-marked-outline: Yes | See [ServiceSafelist](/assemblyline4_docs/odm/models/config/#servicesafelist) for more details. |
...
| value | Any | None | :material-checkbox-marked-outline: Yes | `None` |
...
| Field | Type | Description | Required | Default |
| :--- | :--- | :--- | :--- | :--- |
| type | Keyword | Type of tag item | :material-checkbox-marked-outline: Yes | `None` |
| value | Keyword | Value of tag item | :material-checkbox-marked-outline: Yes | `None` |
| short_type | Keyword | Short version of tag type | :material-checkbox-marked-outline: Yes | `None` |
| score | Integer | Score of tag item | :material-minus-box-outline: Optional | `None` |
