...
| msg_loader | Enum | Class to use to load the message as an object<br>Supported values are:<br>`"assemblyline.odm.messages.task.TaskMessage"` | <div style="width:100px">:material-checkbox-marked-outline: Yes</div> | `assemblyline.odm.messages.task.TaskMessage` |
| msg_type | Enum | Type of message<br>Supported values are:<br>`"Task"` | <div style="width:100px">:material-checkbox-marked-outline: Yes</div> | `Task` |
