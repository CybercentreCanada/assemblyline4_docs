...
| file_tree | Any | File tree of the files in this submission | <div style="width:100px">:material-checkbox-marked-outline: Yes</div> | `{}` |
| file_infos | Mapping [String, Any] | SHA256 and file information in the file. | <div style="width:100px">:material-checkbox-marked-outline: Yes</div> | `{}` |
| errors | List [Keyword] | List of error keys | <div style="width:100px">:material-checkbox-marked-outline: Yes</div> | `[]` |
| results | Mapping [String, Any] | Result key value mapping | <div style="width:100px">:material-checkbox-marked-outline: Yes</div> | `{}` |
