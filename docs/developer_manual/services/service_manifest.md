...
information about the service to the Assemblyline core system, information that the Assemblyline core system must have before
...
| heuristics | List of [Heuristics](#heuristic) | No | List of heuristic(s) used in the service for scoring. Refer to [heuristic](#heuristic) section. | 
